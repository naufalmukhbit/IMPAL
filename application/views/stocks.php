...
<html>
<head>
	<title>Stock Manager's Homepage</title>
			...
			<div class="col-2 sidebar-col-2">
				<nav id="sidebar">
					...
					<ul class="list-unstyled components">
						...
						<li class="side">
							<a href="#reqSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Request</a>
				...
				<div class="container header">
					<div class="row header-row">
						...
						<div class="col-2 pl-5 pr-0 my-auto">
							...
							<a href="<?php echo site_url('Stock/logout'); ?>"><i class="fa fa-sign-out-alt"></i></a>
						</div>
					</div>
				</div>
				<div class="container">
