        ...
        <div class="table-wrapper">
            <div class="table-title" style="background-color: white">
                <div class="row" style="background-color: white">
                    <div class="col-sm-6">
						<h2 style="color: black">Manage <b style="color: black">Service</b></h2>
					</div>
					<div class="col-sm-6">
				...
				<?php foreach ($data -> result() as  $value) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php echo site_url("Service_c/hapus/".$value->idservice) ?>" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                        </td>
					</tr> 
					<?php } ?>
                </tbody>
	...
	<div id="addServiceModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
					...
					<form method="POST" action="<?php echo base_url('Service_c/add'); ?>" enctype="multipart/form-data">				
						<div class="form-group">
							<label>ID Service</label>
							<input type="text" class="form-control" name="idservice" required>
						</div>
						<div class="form-group">
	...
	<div id="editServiceModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
					...
					<div class="modal-body">
					<form method="POST" action="<?php echo site_url("Service_c/editData/".$value->idservice) ?>" enctype="multipart/form-data">					
						<div class="form-group">
							<label>ID Service</label>
							<input type="text" class="form-control" name="idservice" value="<?php echo $this->session->userdata('idservice'); ?>" required>
						</div>
						<div class="form-group">
							<label>Service Type</label>
							<input type="text" class="form-control" name="type" required>
