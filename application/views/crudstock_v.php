		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form>
					...
					<form method="POST" action="<?php echo base_url('Stock_c/add'); ?>" enctype="multipart/form-data">					
						<div class="form-group">
							<label>ID Stock</label>
							<input type="text" class="form-control" name="idstock" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label>Car ID</label>
							<input type="text" class="form-control" name="idcar" required>
						</div>
						<div class="form-group">
							<label>Color</label>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form>
					...
					<div class="modal-body">	
					<form method="POST" action="<?php echo site_url("Stock_c/editData/".$value->idstock) ?>" enctype="multipart/form-data">					
						<div class="form-group">
							<label>ID Stock</label>
							<input type="text" class="form-control" name="idstock" value="<?php echo $this->session->userdata('idstock'); ?>" required>
						</div>
						<div class="form-group">
							<label>Unit Type</label>
							<input type="text" class="form-control" name="unit_type" required>
