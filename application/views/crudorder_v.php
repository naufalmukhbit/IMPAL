	...
	<div id="addOrderModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
					...
					<form method="POST" action="<?php echo base_url('Order_c/add'); ?>" enctype="multipart/form-data">				
						<div class="form-group">
							<label>ID Order</label>
							<input type="text" class="form-control" name="idorder" required>
						</div>
						<div class="form-group">
							<label>Date</label>
	...
	<div id="editOrderModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
					...
					<div class="modal-body">
					<form method="POST" action="<?php echo site_url("Order_c/editData/".$value->idorder) ?>" enctype="multipart/form-data">					
						<div class="form-group">
							<label>ID Order</label>
							<input type="text" class="form-control" name="idorder" value="<?php echo $this->session->userdata('idorder'); ?>" required>
						</div>
						<div class="form-group">
							<label>Date</label>
							<input type="Date" class="form-control" name="date" required>
